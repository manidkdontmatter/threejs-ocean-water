...
var OceanSystem = class {
  ...
  group = new Group();
  ringDebugGroup = new Group();
  shallowColor = new Color();
  deepColor = new Color();
  foamColor = new Color();
  skyHorizonColor = new Color();
  skyZenithColor = new Color();
...
// src/lib/Ocean.ts
var GEOMETRY_OPTION_KEYS = /* @__PURE__ */ new Set([
  "ringCount",
  "baseRingWidth",
  "ringWidthGrowth",
...
var Ocean = class {
  ...
  constructor(options) {
    ...
    this.timeSec = this.settings.useServerTime ? this.settings.serverTimeSec : 0;
